...
<smtpad portHints={["pin4"]} pcbX="2.300097mm" pcbY="-1.8250154mm" width="1.499997mm" height="1.999996mm" shape="rect" />
<smtpad portHints={["pin5"]} pcbX="-2.300097mm" pcbY="-1.8250154mm" width="1.499997mm" height="1.999996mm" shape="rect" />
...
<courtyardoutline outline={[{"x":-3.2938089999998965,"y":3.0874086000000034},{"x":3.302191000000107,"y":3.0874086000000034},{"x":3.302191000000107,"y":-3.051391399999943},{"x":-3.2938089999998965,"y":-3.051391399999943},{"x":-3.2938089999998965,"y":3.0874086000000034}]} />
      ...
      cadModel={{
        ...
        pcbRotationOffset: 0,
        modelOriginPosition: { x: 0.9999237999999614, y: 0.4570101999999934, z: -0.01 },
      }}
      {...props}
    />
  )
